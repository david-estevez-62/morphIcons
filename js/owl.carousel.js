        ...
        closestItem: function() {
            ...
            e.each(n, function(s, o) {
                if (r - t.itemWidth / 90 > n[s + 1] && r - t.itemWidth / 90 < o && t.moveDirection() === "left") {
                    i = o;
                    if (t.options.scrollPerPage === true) {
                ...
                } else if (r + t.itemWidth / 90 < o && r + t.itemWidth / 90 > (n[s + 1] || n[s] - t.itemWidth) && t.moveDirection() === "right") {
                    if (t.options.scrollPerPage === true) {
